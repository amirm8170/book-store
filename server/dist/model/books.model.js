...
exports.Books = exports.validBook = void 0;
...
const validBook = (bookInfo) => {
    const schema = joi_1.default.object({
        title: joi_1.default.string().required().max(255),
        description: joi_1.default.string().required().max(2000),
        author: joi_1.default.string().required().max(255),
        year: joi_1.default.number().min(0).max(new Date().getFullYear()).required(),
        cover: joi_1.default.string().max(1000).uri().required(),
    });
